        ...
        {!parsed ? (
          <div className="p-5 space-y-4 overflow-y-auto">
            <button
              ...
              className={`w-full flex flex-col items-center gap-3 rounded-2xl border-2 border-dashed px-6 py-10 transition ${
  ...
  return (
    <div>
      ...
      <button
        onClick={() => onLoad(text)}
        disabled={!text.trim()}
        className="mt-2 w-full rounded-xl bg-slate-900 px-4 py-3 text-sm font-semibold text-white transition active:scale-[0.98] disabled:opacity-40"
      >
        Parse pasted leads
      </button>
    </div>
